...
function f3() {
  let divOut3 = document.getElementsByClassName("out-3");
  console.log(divOut3);
  for (let i = 0; i < divOut3.length; i++) {
    divOut3[i].innerHTML = "3";
  }
}
...
function f4() {
  ...
  for (let i = 0; i < divOut4.length; i++) {
    divOut4[i].innerHTML += 4;
  }
  console.log(divOut4);
}
...
function f15() {
  let divOut15 = document.querySelectorAll("div.out-15");
  for (let item of divOut15) {
    item.innerHTML = 15;
  }
}
